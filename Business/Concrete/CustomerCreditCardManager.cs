...
namespace Business.Concrete
{
    public class CustomerCreditCardManager : ICustomerCreditCardService
    {
        ...
        public IDataResult<List<CreditCard>> GetSavedCreditCardsByCustomerId(int customerId)
        {
            ...
            return new SuccessDataResult<List<CreditCard>>(userCreditCards, Messages.Listed);
        }
        ...
        IDataResult<List<CreditCard>> ICustomerCreditCardService.GetSavedCreditCardsByCustomerId(int customerId)
        {
